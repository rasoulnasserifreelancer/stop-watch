...
function App() {
  ...
  return (
    <div className='flex flex-col min-h-screen items-center justify-evenly bg-gray-600'>
      ...
      <p> <span className='mr-3 font-bold font-serif mask-radial-from-neutral-950'>Time Passed :</span> <span className='text-white tracking-widest'>{timePassed.toFixed(3)}</span>  </p>
